function save_volume_mask(params, loop_params)
    ...
    % prepare output
    out_path = fullfile(params.workspace, 'data', 'mesh_mask', mesh_model);
    ...
    for ii = 1:length(region_idxs)
        ...
        matrix = mesh_get_tetrahedron_centers(m); 
        ...
        out_name = strcat(mesh_model, '_', element, '_', compartment, '.mat');
        save(fullfile(out_path, out_name), 'roi_mask');
    end    
end