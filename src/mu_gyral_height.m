function mu_gyral_height(index)
    %% Info
    % Run multi-scale modeling on HPC.
    % Aim: Study effect of gyral height.
    ...
    params.model_idx = [3; 17; 31; 45; 59];
    ...
    params.sim_id = strcat(params.folder_flag, '_gyral_height');
    ...
    sim_params = struct();
    sim_params.mesh_model = params.mesh_models{params.model_idx(index, 1), 1};
    sim_params.efield_sim = strcat(sim_params.mesh_model, '_angle_', num2str(params.angles(1, 1))); 
    ...
    sim_params.nrn_locations_all = load(fullfile(params.workspace, 'data', 'nrn_locs', sim_params.mesh_model, strcat(sim_params.mesh_model, '_locations.mat')));
    ...
    save(fullfile(params.folder, strcat(sim_params.label, '_', sim_params.mesh_model, '_sim_params.mat')), 'sim_params');
