...
delay_start = 10; % delay at the beginning before TMS delivery
delay_end = 25; % delay after the TMS delivery
ipi = round(ipi/dt)*dt;
...
%% Save train
save('TMS_E_train.txt', 'train_E','-ascii');
save('TMS_t_train.txt', 'train_t','-ascii');
save('TMS_timing.txt', 'timing', '-ascii');
